...
// nêú không có URL nào khớp router-dom, sẽ báo Not Found
const NotFound = () => {
  const { pathname } = useLocation(); //lấy thông tin đường dẫn hiện tại truyền vào path
          ...
          <div className="text-center">
            ...
            <h1 className="mt-2 text-3xl font-bold tracking-tight text-darkText">
              <span className="text-redText underline underline-offset-2 decoration-[1px] capitalize">
                {path} {/* hiển thị tên đường dẫn truyền vào path */}
              </span>{" "}
              does not exist
            </h1>
