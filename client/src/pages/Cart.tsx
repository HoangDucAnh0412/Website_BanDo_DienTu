...
const Cart = () => {
  const [totalAmt, setTotalAmt] = useState({ regular: 0, discounted: 0 }); // lưu trữ tổng số tiền của các sản phẩm trong giỏ hàng
  ...
  return (
    <Container> {/*Nếu có sản phẩm trong giỏ hàng sẽ hiển thị danh sách sản phẩm, thông tin thanh toán */}
      {cartProduct.length > 0 ? (
        ...
        // Nếu giỏ hàng trống sẽ hiển thị
