...
const Registration = () => {
  ...
  // Xử lý thay đổi khi người dùng chọn một ảnh đại diện. Nó lưu trữ file và URL của ảnh để hiển thị trong giao diện
  ...
  // Xử lý sự kiện gửi form để đăng ký người dùng
  const handleRegistration = async (e: any) => {
    ...
    try {
      setLoading(true);
      // Tạo tài khoản người dùng mới bằng createUserWithEmailAndPassword
      const res = await createUserWithEmailAndPassword(auth, email, password);
      let imageUrl = null;
      // Tải ảnh đại diện lên và lưu URL ảnh vào Firestore
