    ...
    <div className="flex py-6">
      <div className="min-w-0 flex-1 lg:flex lg:flex-col">
        ...
        <p>
          ...
          {/* Hiển thị số tiền người dùng tiết kiệm được khi mua sản phẩm, được tính bằng cách lấy giá gốc trừ đi giá giảm */}
            <FormattedPrice
      ...
      {/* Cho phép người dùng nhấp vào để điều hướng đến trang chi tiết sản phẩm */}
      <div
